...
public class Reservation extends Service {
    ...
    public Reservation(Long customerId, LocalDate serviceDate, LocalTime serviceTime, double reservationFee,
			boolean active, Table table) {
	...
	public static Duration getOverduethreshold() {
	...
	public Reservation(Long customerId, LocalDate serviceDate, LocalTime serviceTime) {
		super(customerId, serviceDate, serviceTime);
	}
