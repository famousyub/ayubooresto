...
public class ImmediateReservationTransaction extends AddReservationTransaction {
    ...
    Reservation getReservation() {
        Reservation reservation = new Reservation(getCustomerId(), getReservationDate(), getReservationTime());
        		//Reservation( getTableId(), getCustomerId(), getReservationDate(), getReservationTime(), getReservationFee() );
